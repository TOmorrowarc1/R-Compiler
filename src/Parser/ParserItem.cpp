...
//The declarations are generated by Gemini.
auto parseItemModuleNode(TokenStream &stream) -> std::unique_ptr<ItemModuleNode>;
...
auto parseItemStructNode(TokenStream &stream) -> std::unique_ptr<ItemStructNode>;
